      ...
      <div className="max-w-screen-xl mx-auto p-4 flex justify-between items-center">
        <NavLink to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img
            ...
            alt="Logo"
          />
          <span className="text-2xl font-bold dark:text-white">Daily Needs & Services</span>
        </NavLink>
        <button
          onClick={toggleMenu}
        ...
        <div className={`${isMenuOpen ? "block" : "hidden"} md:block w-full md:w-auto`} id="navbar-user">
